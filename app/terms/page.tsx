  ...
  return (
    ...
    >
      ...
      <p>
        ...
        contracted medical practices. Pharmacy services are provided by appropriately licensed pharmacy partners. The
        identity of the applicable clinical practice, treating provider, and dispensing pharmacy will be disclosed as
        required by applicable law and during the applicable care or fulfillment process.
      </p>
      <p>
      ...
      <p>
        ...
        requirements and that all information you provide, including your identity, age, location, contact information,
        and health information, is accurate, current, and complete.
      </p>
      <p>
        You may be asked to verify your identity, age, location, or other eligibility information. The Company or a
        healthcare provider may suspend or decline access to the Services if required information cannot be verified.
      </p>
      ...
      <p>
        ...
        laboratory service, pharmacy, shipping method, or subscription option is available in every state. Availability
        may change without notice. A provider may require a synchronous video or telephone consultation, laboratory
        testing, medical records, an in-person examination, or other information before making a treatment decision.
      </p>
      ...
      <p>
        ...
        directing care, and providing clinical follow-up.
      </p>
      <p>
        The Company does not control a pharmacy’s professional judgment, dispensing decisions, compounding decisions,
        labeling, counseling, fulfillment practices, or compliance obligations. A pharmacy may decline or delay
        fulfillment when legally or clinically required.
      </p>
      <p>
        Your relationship with a healthcare provider or pharmacy may also be governed by separate notices, consents,
        policies, or terms provided by that provider, medical practice, or pharmacy.
      </p>
      ...
      <p>
        ...
        circumstances, care may be provided asynchronously, meaning that the provider reviews submitted information
        without a simultaneous live interaction.
      </p>
      <p>
        ...
        treatment, or recommend in-person or emergency care. You must complete any state-specific telehealth informed
        consent presented to you before receiving clinical services.
      </p>
      ...
      <p>
        ...
        create a guarantee of treatment or a prescription. A licensed healthcare provider must first provide an
        appropriate clinical evaluation and determine that treatment is clinically appropriate and permitted by
        applicable law.
      </p>
      <p>
        No prescription or prescription medication will be issued, dispensed, or shipped before the required provider
        evaluation and issuance of a valid prescription by an authorized prescriber.
      </p>
      ...
      <p>
        Some treatment plans may involve compounded medications when prescribed for an identified patient and permitted
        by applicable federal and state law. Compounded medications are not approved by the U.S. Food and Drug
        Administration (“FDA”), and the FDA does not review compounded medications for safety, effectiveness, or quality
        before they are marketed. A compounded medication is not an FDA-approved generic medication and should not be
        represented as identical or therapeutically equivalent to an FDA-approved product unless such a statement is
        legally authorized and substantiated.
      </p>
      <p>
        ...
        FDA-approved, is a generic version of an FDA-approved product, or is equivalent to a branded product. Medication
        availability is subject to applicable law, pharmacy authorization, ingredient availability, patient-specific
        clinical need, and the provider’s independent judgment.
      </p>
      ...
      <p>
        ...
        uploads, laboratory results, and communications with providers. You must disclose relevant diagnoses, symptoms,
        allergies, medications, supplements, pregnancy status, medical history, and other information requested by your
        provider.
      </p>
      <p>
      ...
      <p>
        ...
        activity under your account. You may not share your account, impersonate another person, create an account using
        false information, or submit health information on behalf of another person unless expressly authorized and
        legally permitted.
      </p>
      ...
      <p>
        Prescription required. Treatment is not guaranteed. Your information is submitted for licensed provider review
        in connection with the checkout process. The prices, consultation fees, medication charges, shipping charges,
        taxes, recurring charges, and any other material fees applicable to your purchase will be disclosed before you
        authorize payment.
      </p>
      <p>
        You authorize the Company and its payment processors to charge your selected payment method for the amounts
        disclosed to you. If a provider determines that prescription treatment is not clinically appropriate, amounts
        paid for medication that will not be dispensed will be handled according to the refund policy disclosed at
        checkout. Consultation, technology, administrative, laboratory, or other fees may be nonrefundable when clearly
      ...
      <p>
        ...
        products may not be cancelable, returnable, or refundable except as required by law or expressly stated in the
        applicable refund policy. The refund and cancellation terms displayed at checkout are incorporated into these
        Terms.
      </p>
      ...
      <p>
        ...
        processing, product or ingredient availability, prescription clarification, address verification, carrier delays,
        weather, holidays, and applicable law.
      </p>
      <p>
        Medications will be shipped only to locations where the dispensing pharmacy is authorized to dispense and ship
        the medication. You are responsible for providing a complete and accurate delivery address and for following
        storage, handling, and use instructions provided by the pharmacy or provider.
      </p>

      <h2>15. Refills, Subscriptions, Pauses, and Cancellations</h2>
      <p>
        If a plan includes recurring billing, recurring clinical review, refills, or subscription services, the billing
        cadence, renewal terms, cancellation process, refill conditions, and applicable fees will be disclosed at
      ...
      <p>
        ...
        require updated information, require laboratory testing or a consultation, or recommend alternative or in-person
        care. You may cancel recurring non-clinical services through the method disclosed at checkout or in your
        account, subject to any lawful cutoff periods for prescriptions already submitted for fulfillment.
      </p>
      ...
      <p>
        The Services do not guarantee weight loss, hair growth, improved energy, improved performance, hormone changes,
        laboratory results, symptom improvement, or any other result. Individual results vary, and all treatments involve
        potential risks, limitations, and alternatives that should be discussed with a licensed healthcare provider.
      </p>
      ...
      <p>Do not disregard or delay seeking professional medical advice because of information presented through the Services.</p>
      ...
      <p>
        ...
        permission. All rights not expressly granted are reserved. Third-party names and trademarks remain the property
      ...
      <p>
        ...
        parties. These third parties are responsible for their own services and may provide separate terms and privacy
        notices.
      </p>
      <p>
        The Company seeks to work only with appropriately licensed and authorized partners. The inclusion of a third
        party does not constitute a guarantee regarding the availability of that third party or any specific service.
      </p>
      ...
      <p>
        ...
        medical practices, laboratories, and pharmacies may also provide separate privacy notices or Notices of Privacy
        Practices describing how they use and disclose protected health information.
      </p>
      <p>
        The Company and its applicable partners will process personal and health information in accordance with
        applicable privacy and security laws. Sensitive information transmitted through the Services will be protected
        using reasonable administrative, technical, and physical safeguards, including encryption in transit where
      ...
      <p>
        ...
        available” basis without warranties of any kind, whether express or implied, including warranties of
        merchantability, fitness for a particular purpose, non-infringement, accuracy, availability, or course of
        dealing.
      </p>
      <p>
        Nothing in this section disclaims or limits duties that cannot lawfully be disclaimed, including duties owed by
        licensed healthcare providers or pharmacies under applicable professional and consumer-protection laws.
      </p>
      ...
      <p>
        ...
        consequential, exemplary, or punitive damages, or for loss of profits, revenues, data, goodwill, or business
        opportunity, arising from use of or inability to use the Company’s non-clinical Services.
      </p>
      <p>
        This limitation does not apply where prohibited by law and does not limit liability for professional negligence,
        willful misconduct, fraud, or other liability that cannot lawfully be limited.
      </p>

      <h2>24. Indemnification</h2>
      <p>
        To the fullest extent permitted by law, you agree to indemnify, defend, and hold harmless the Company and its
        affiliates, officers, directors, employees, contractors, licensors, and non-clinical service providers from
        claims, liabilities, damages, losses, and expenses, including reasonable attorneys’ fees, arising from your
        unlawful use of the Services, material violation of these Terms, violation of third-party rights, or submission
      ...
      <p>
        ...
        Terms from time to time. The updated Terms will be posted with a revised “Last updated” date. Where required by
        law, we will provide additional notice or obtain consent before material changes become effective.
      </p>

      <h2>26. Governing Law and Dispute Resolution</h2>
      <p>
        These Terms are governed by the laws of the State of Florida, without regard to conflict-of-law principles,
        except where applicable law requires otherwise. Any arbitration agreement, venue provision, class-action waiver,
        or other dispute-resolution requirement should be inserted here only after review by qualified legal counsel and
      ...
      <p>{states.join(", ")}.</p>
      <p>
        You must be physically located in the applicable state at the time clinical services are provided. The treating
        provider must be authorized to practice in that state, and the dispensing pharmacy must be authorized to dispense
        and ship the prescribed medication to that state. Not every treatment, medication, provider, pharmacy, or
        fulfillment option is available in every listed state.
      </p>
      ...
      <ul>
        ...
        <li>Final treatment, formulation, dose, pharmacy, and pricing may vary based on provider review, patient-specific needs, pharmacy availability, and applicable law.</li>
        <li>Product imagery is illustrative and does not imply that the Company manufactures, compounds, dispenses, or physically fulfills medication. Actual packaging and pharmacy labeling may differ.</li>
